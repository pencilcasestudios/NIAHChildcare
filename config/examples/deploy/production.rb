...
namespace :deploy do
  ...
  task :sync_assets do
    ...
    run_locally "rsync --verbose --stats --progress --compress --archive --partial --recursive --times --perms --links --delete --exclude '.*' --delete-excluded ~/Code/Rails/#{application}/app/assets/images/ #{user}@#{DEPLOYMENT_CONFIG["production_server_name"]}:#{asset_vault_path}/#{application}/Images/"
