...
namespace :deploy do
  ...
  task :sync_assets do
    ...
    run_locally "rsync --verbose --stats --progress --compress --archive --partial --recursive --times --perms --links --delete --exclude '.*' --delete-excluded ~/Projects/Rails/#{application}/app/assets/images/ #{user}@#{DEPLOYMENT_CONFIG["staging_server_name"]}:#{asset_vault_path}/#{application}/Images/"
