...
namespace :deploy do
  ...
  task :sync_assets do
    ...
    run_locally "rsync --verbose --stats --progress --compress --archive --partial --recursive --times --perms --links --delete --exclude '.*' --delete-excluded #{Rails.root}/app/assets/images/backgrounds/ #{user}@#{DEPLOYMENT_CONFIG["virtual_server_name"]}:#{asset_vault_path}/#{application}/Images/Backgrounds/"
