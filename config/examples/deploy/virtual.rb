...
set :deployment_server, DEPLOYMENT_CONFIG["virtual_server_name"]
...
namespace :deploy do
  ...
  task :sync_assets do
    ...
    run_locally "rsync --verbose --stats --progress --compress --archive --partial --recursive --times --perms --links --delete --exclude '.*' --delete-excluded ~/Projects/Rails/NIAHChildcare/app/assets/images/backgrounds/ #{user}@#{deployment_server}:#{asset_vault_path}/#{application}/Images/Backgrounds/"
